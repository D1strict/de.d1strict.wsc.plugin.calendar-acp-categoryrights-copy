...
class CategoryRightsCopyForm extends AbstractForm  {
	 ...
	 */
	public $activeMenuItem = 'calendar.acp.menu.link.calendar.category.rights.copy';

	/**
	 * @see	\wcf\page\AbstractPage::$neededPermissions
	 */
	public $neededPermissions = array('admin.calendar.canManageCategory');
	...
	public function readParameters() {
		...
		$this->objectTypeID = ACLHandler::getInstance()->getObjectTypeID('com.woltlab.calendar.category');
	}
	...
	public function assignVariables() {
		...
		$categoryTree = new CalendarCategoryNodeTree('com.woltlab.calendar.category', 0, true, array());
