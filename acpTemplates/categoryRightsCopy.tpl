{include file='header' pageTitle='calendar.acp.event.category.rights.copy'}
...
<header class="boxHeadline">
	<h1>{lang}calendar.acp.event.category.rights.copy{/lang}</h1>
</header>
...
<form method="post" action="{link application='calendar' controller='CategoryRightsCopy'}{/link}">
	<div class="tabMenuContainer" data-active="{$activeTabMenuItem}" data-store="activeTabMenuItem">
		<nav class="tabMenu">
			<ul>
				<li><a href="{@$__wcf->getAnchor('general')}">{lang}calendar.acp.event.category.rights.copy{/lang}</a></li>
			...
			<fieldset>
				{hascontent}
					<dl{if $errorField == 'sourceCategoryID'} class="formError"{/if}>
						<dt><label for="sourceCategoryID">{lang}calendar.acp.event.category.sourceCategoryID{/lang}</label></dt>
						<dd>
							...
							{if $errorField == 'sourceCategoryID'}
								<small class="innerError">
									{lang}calendar.acp.event.category.sourceCategoryID.error.{@$errorType}{/lang}
								</small>
							{/if}
						</dd>
					</dl>
				...
				{hascontent}
					<dl {if $errorField == 'targetCategoryIDs'} class="formError"{/if}>
					    <dt><label for="targetCategoryIDs">{lang}calendar.acp.event.category.targetCategoryIDs{/lang}</label></dt>
					    <dd>
							...
							{if $errorField == 'targetGroupIDs'}
								<small class="innerError">
									{lang}calendar.acp.event.category.targetCategoryID.error.{@$errorType}{/lang}
								</small>
							{/if}
					    </dd>
					</dl>
	...
	<div class="formSubmit">
		<input type="submit" value="{lang}calendar.acp.event.category.copy{/lang}" accesskey="s" />
